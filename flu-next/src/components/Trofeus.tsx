...
import { Trophy } from 'lucide-react';
// Não precisamos mais do array 'trophies' aqui dentro, pois os dados virão dos outros componentes

export const Trofeus = () => {
  return (
    <section id="trofeus-header" className="pt-20 pb-10 bg-gray-50">
      <div className="container mx-auto px-4">
        
        {/* CABEÇALHO DA SEÇÃO */}
        <div className="text-center mb-12 animate-slide-up">
          <p className="text-sm uppercase tracking-[0.3em] text-[#eab308] mb-2 font-bold">
            Conquistas
          </p>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            SALA DE <span className="text-[#eab308]">TROFÉUS</span>
          </h2>
          <div className="w-24 h-1 bg-linear-to-r from-[#006F39] via-[#eab308] to-[#9E0D2C] mx-auto rounded-full" />
        </div>

        {/* CONTADORES (BIG NUMBERS) */}
        <div className="flex flex-wrap justify-center gap-8 animate-slide-up animation-delay-100">
          <div className="text-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 min-w-[150px] transform hover:-translate-y-1 transition-transform">
            <div className="text-5xl md:text-6xl font-black text-[#eab308] mb-2">63</div>
            <p className="text-gray-500 uppercase tracking-wider text-sm font-bold">Títulos Oficiais</p>
          </div>
          <div className="text-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 min-w-[150px] transform hover:-translate-y-1 transition-transform">
            <div className="text-5xl md:text-6xl font-black text-[#006F39] mb-2">1</div>
            <p className="text-gray-500 uppercase tracking-wider text-sm font-bold">Libertadores</p>
          </div>
          <div className="text-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 min-w-[150px] transform hover:-translate-y-1 transition-transform">
            <div className="text-5xl md:text-6xl font-black text-[#9E0D2C] mb-2">33</div>
            <p className="text-gray-500 uppercase tracking-wider text-sm font-bold">Cariocas</p>
          </div>
        </div>
      </div>
